...
const SizedBox kheight125 = SizedBox(
  height: 25,
);
...
const SizedBox kwidth5 = SizedBox(
  width: 5,
);
...
const SizedBox kwidth15 = SizedBox(
  width: 10,
);

const SizedBox kwith20 = SizedBox(
  width: 20,
);
...
BoxDecoration logoContainerStyle() {
